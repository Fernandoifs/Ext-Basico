Ext.define('Extbasico.view.agenda.agendaview', {
    extend: 'Ext.grid.Grid',
    xtype: 'agendaview',
    cls: 'agendaview',
    requires: ['Ext.grid.rowedit.Plugin'],
    controller: { type: 'agendacontroller' },
    viewModel: { type: 'agendamodel' },
    store: { type: 'storeagendashared' }, //declaração do store para usar na grid
    grouped: true,
    plugins: {
        rowedit: {
            autoConfirm: false
    ...
    items: [{
        ...
        },
        {
            ...
            // store: {
            //     type: 'storeagendashared', //componente store criado, basta declarar dessa forma
            //     autoLoad: true
            // }
        }
        ]
