Ext.define('Extbasico.view.dashboard.dashboardview', {
    extend: 'Ext.grid.Grid',
    xtype: 'dashboardview',
    cls: 'dashboardview',
    requires: ['Ext.grid.rowedit.Plugin'],
    controller: { type: 'dashboardcontroller' },
    viewModel: { type: 'dashboardmodel' },
    store: { type: 'storedashboardshared' }, //declaração do store para usar na grid
    grouped: true,
    plugins: {
        rowedit: {
            autoConfirm: false
    ...
    items: [{
        ...
        },
        {
            ...
            // store: {
            //     type: 'storedashboardshared', //componente store criado, basta declarar dessa forma
            //     autoLoad: true
            // }
        }
        ]
