Ext.define('Extbasico.view.minhaconta.minhacontaview', {
    extend: 'Ext.grid.Grid',
    xtype: 'minhacontaview',
    cls: 'minhacontaview',
    requires: ['Ext.grid.rowedit.Plugin'],
    controller: { type: 'minhacontacontroller' },
    viewModel: { type: 'minhacontamodel' },
    store: { type: 'storeminhacontashared' }, //declaração do store para usar na grid
    grouped: true,
    plugins: {
        rowedit: {
            autoConfirm: false
    ...
    items: [{
        ...
        },
        {
            ...
            // store: {
            //     type: 'storeminhacontashared', //componente store criado, basta declarar dessa forma
            //     autoLoad: true
            // }
        }
        ]
